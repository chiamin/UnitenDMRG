...
def svd_compress_mps(
    ...
    *,
    ...
    for p in range(N - 2, -1, -1):
        ...
        phi.set_sites({p: left_new, p + 1: right_new})
        phi.center_left  = p
        phi.center_right = p
...
# mixed directions.  The density matrix built here has mixed bond directions;
# SVD on rho.Dagger() (needed for correct output bond directions) triggers
# the bug and segfaults.  The code below is correct — only the cytnx backend
# is broken.
